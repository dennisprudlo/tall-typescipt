...
var alpinejs_1 = __importDefault(__webpack_require__(/*! alpinejs */ "./node_modules/alpinejs/dist/module.esm.js"));

var Application_1 = __webpack_require__(/*! ./common/Application */ "./resources/js/common/Application.ts");

var Modal_1 = __webpack_require__(/*! ./common/Modal */ "./resources/js/common/Modal.ts");

Application_1.app.bind({
  Alpine: alpinejs_1["default"],
  Modal: Modal_1.Modal
}).ready(function () {//
});
...
/***/ "./resources/js/common/Application.ts":
/*!********************************************!*\
  !*** ./resources/js/common/Application.ts ***!
  \********************************************/
...
var Application = /*#__PURE__*/function () {
  ...
  function Application() {
    ...
    this.locale = (_document$querySelect = (_document$querySelect2 = document.querySelector('html')) === null || _document$querySelect2 === void 0 ? void 0 : _document$querySelect2.getAttribute('lang')) !== null && _document$querySelect !== void 0 ? _document$querySelect : 'de';
  }
  /**
  ...
  _createClass(Application, [{
    ...
    key: "bind",
    value: function bind(properties) {
      for (var property in properties) {
        window[property] = properties[property];
      }
...
var Modal = function Modal(path, params) {
  if (path) {
    return window.Livewire.emit('openModal', "modals.".concat(path), params || []);
  }
  ...
  return {
    ...
    hide: function hide(event) {
      ...
      if (!!event.target && (event.target.closest('.pika-lendar') !== null || event.target.closest('.pika-time-container') !== null)) {
        return;
      }
...
/******/ 	__webpack_require__.O(undefined, ["css/app.min"], () => (__webpack_require__("./resources/js/app.ts")))
